...
execute if block ~ ~ ~ #minecraft:furnaces run function minecraft:lava_and_furnace/nbt_check
execute unless block ~ ~ ~ #minecraft:furnaces unless score #raycast b_global matches 51.. positioned ^ ^ ^0.1 run function minecraft:lava_and_furnace/raycast
